	...
	AnimOnScroll.prototype = {
		...
		_init: function () {
			...
			imagesLoaded(this.el, function () {
				...
				let p1 = parseInt(document.querySelector('ul.grid li:nth-last-child(1)').style.top.replace('px', ''))
				let p2 = parseInt(document.querySelector('ul.grid li:nth-last-child(2)').style.top.replace('px', ''))
...
jQuery(document).ready(function ($) {
	...
	$('.cd-projects-container').on('scroll', () => {
